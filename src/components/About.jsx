    ...
    <div name="about" className='w-full h-screen bg-gradient-to-b from bg-gray-900 to to-black text-white'>
        <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
            ...
            <div>
                ...
                <p className='text-xl'>Hello! I'm Avigyat, a passionate and versatile Full Stack Developer specializing in MEAN/MERN stacks and .NET . With a strong foundation in both front-end and back-end technologies, I bring a holistic approach to web development.</p><br/>
                ...
                <p className='text-xl'>I am excited about the endless possibilities at the intersection of MEAN/MERN stacks and .NET development. If you are looking for a developer who can seamlessly navigate the complexities of both worlds, let's connect. Together, we can turn your ideas into reality and create technology solutions that make a lasting impact.</p>
